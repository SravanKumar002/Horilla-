            ...
            return HttpResponse(
                ...
                {mouse_out}
                    hx-get="/attendance/clock-out"
                        ...
                        hx-swap='innerHTML'><i class="mdi mdi-clock text-white"></i>
                <span {hidden_label} class="hr-check-in-out-text">{clock_out}</span>
                    <div class="time-runner"></div>
                </button>
                {script}
                """.format(
                    clock_out=_("Clock-Out"),
                    script=script,
        ...
        return HttpResponse(
            """
              ...
              <i class="mdi mdi-clock text-white"></i>
                ...
                <span class="hr-check-in-out-text" {hidden_label} >{clock_in}</span>
