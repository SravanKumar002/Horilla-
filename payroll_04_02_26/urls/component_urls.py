...
urlpatterns = [
    ...
    # payroll 
    path('run-payroll/', component_views.run_payroll, name='run-payroll'),
    path(
        "payslip-info-import",
        component_views.payslip_import_info, # ✨ यह नया view फ़ंक्शन है
        name="payslip-info-import",
    ),
    path(
        "payslip-import-template",
        component_views.payslip_import_template,
        name="payslip-import-template",
    ),
    path(
        "payslip-import-process",
        component_views.payslip_import_process, # ✨ यह नया view फ़ंक्शन है
        name="payslip-import-process",
    ),
    path(
        "payslip-import-download",
        component_views.payslip_import_download,
        name="payslip-import-download",
    ),
    path(
        "external-components-export/",
        component_views.external_components_export,
        name="external-components-export",
    ),
]
