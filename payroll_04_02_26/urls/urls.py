...
from payroll.views.component_views import import_employees
...
urlpatterns = [
    ...
    path(
        "payslip-inline-edit/<int:payslip_id>/",
        views.payslip_inline_edit,
        name="payslip-inline-edit",
    ),
    path(
    ...
    path('import-employees/', import_employees, name='import_employees'),
]
